...
tags:
  - inf_bsc_2014
---
[Report an error](https://github.com/SGSSGene/FUB-SUP/issues/new?title=Error in "Logik und Diskrete Mathematik"&body=There seems to be an error in module "Logik und Diskrete Mathematik".
