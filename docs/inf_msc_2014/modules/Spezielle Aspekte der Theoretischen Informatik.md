...
tags:
  - inf_msc_2014
---
[Report an error](https://github.com/SGSSGene/FUB-SUP/issues/new?title=Error in "Spezielle Aspekte der Theoretischen Informatik"&body=There seems to be an error in module "Spezielle Aspekte der Theoretischen Informatik".
...
[« Spezielle Aspekte der Technischen Informatik](Spezielle Aspekte der Technischen Informatik.md){class=prev}
[Telematik »](Telematik.md){class=next}
{class=prev-next-nav}

<table markdown id="moduledesc">
<tr markdown class="moduledesc_head"><th colspan="2">Spezielle Aspekte der Theoretischen Informatik </th></tr>
