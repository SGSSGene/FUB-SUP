...
tags:
  - inf_msc_2014
---
[Report an error](https://github.com/SGSSGene/FUB-SUP/issues/new?title=Error in "Spezielle Aspekte der Datenverwaltung"&body=There seems to be an error in module "Spezielle Aspekte der Datenverwaltung".
...
[« Softwareprozesse](Softwareprozesse.md){class=prev}
[Spezielle Aspekte der Praktischen Informatik »](Spezielle Aspekte der Praktischen Informatik.md){class=next}
{class=prev-next-nav}
