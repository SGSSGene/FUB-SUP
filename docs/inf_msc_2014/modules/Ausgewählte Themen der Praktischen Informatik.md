...
tags:
  - inf_msc_2014
---
[Report an error](https://github.com/SGSSGene/FUB-SUP/issues/new?title=Error in "Ausgewählte Themen der Praktischen Informatik"&body=There seems to be an error in module "Ausgewählte Themen der Praktischen Informatik".
