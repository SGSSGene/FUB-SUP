...
|**Qualifikationsziele**             | Die Studentinnen und Studenten verstehen grundlegende Methoden der kommutativen Algebra in Verbindung mit der Entwicklung einer geometrischen Sichtweise und können sicher damit umgehen. |
|**Inhalte**                         | Es wird eine Auswahl aus folgenden Themen behandelt: Moduln über Ringen, Endlichkeitsbedingungen, Primärzerlegung, Flachheitskriterien, Gröbnerbasen, Derivationen, Graduierungen und Hilbertfunktionen, Hilbertpolynome, Dimensionstheorie, Dedekind Ringe, Dualitätstheorie, homologische Algebra und Darstellungstheorie. |
