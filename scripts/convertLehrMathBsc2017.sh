...
name="lehramtsbezogene Mathematik Bachelors"
degree=lehrmath_bsc_2017
url=https://www.imp.fu-berlin.de/fbv/pruefungsbuero/Studien--und-Pruefungsordnungen/LA-BSc-Mathematik-_2017_.pdf
...
Das Original ist hier zu finden: [StO/PO 2017 (Bachelor)](${url}).
