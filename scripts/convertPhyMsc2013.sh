...
year=2013
degree=phy_msc_${year}
url=https://www.imp.fu-berlin.de/fbv/pruefungsbuero/Studien--und-Pruefungsordnungen/StOPO_MSc_-Physik-2013.pdf
...
(
    ...
    i=5
    echo "page: $i" >> $log
    get_one_column_page $i
) > result/${degree}/spo.md
...
export XQ_STARTPAGE=7
export XQ_ENDPAGE=37
./scripts/extractStudienordnung.xq caches/${degree}/prefix.xml > result/${degree}/modules.yaml
